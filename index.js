...
careerResults.innerHTML = "Generating advice💡...";
 ...
 let apiUrl = `https://api.shecodes.io/ai/v1/generate?prompt=${userGoal}&context=Give concise career guidance. Use a title, a short introduction, and exactly 2 numbered sections with short points. Focus only on the most important advice. Avoid long explanations. Format using HTML headings, paragraphs, and lists. Do not use Markdown.&key=${apiKey}`;
